                    ...
                    collector.on("collect", async (m) => {
                        ...
                        await OldRoles.findOne({ roleID: mesaj }).then(async (err, data) => {
                            if (!data) {
                                ...
                                if (arismis) arismis.edit({ embeds: [new Discord.EmbedBuilder().setDescription(`${mesaj} ID'li rolün herhangi bir datası bulunamadı! Rol kurulumu iptal edildi!`)] })
                                return
                            }
                            ...
                            for (let index = 0; index < Bots.length; index++) {
                                ...
                                if (members.length <= 0) {
                                    ...
                                    if (arismis) arismis.edit({ embeds: [new Discord.EmbedBuilder().setDescription(`${mesaj} ID'li rolün üyelerine rol dağıtıldığı için ya da üye olmadığı için iptal edildi!`)] })
                                    break;
                                }
                            ...
                            if (arismis) arismis.edit({ embeds: [new Discord.EmbedBuilder().setDescription(`${mesaj} ID'li rolün yedeği açıldı ve üyelerine dağıtılmaya başlandı!`)] })
